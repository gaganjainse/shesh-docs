---
title: "ADR-0009: Fork Newelle as shesh-voice with an overlay"
type: explanation
summary: "Fork Newelle as shesh-voice with an overlay."
audience: maintainer
status: current
verified: 2026-08-15
---
...
The fleet needs wake word, STT, TTS, chat UI, and MCP client. Newelle (qwersyk/Newelle) is GPL-3.0, has all of these: openwakeword, faster-whisper, Piper/Kokoro/Edge TTS, subagents, skills, STDIO MCP since 1.4.5, Telegram interface, OpenAI-compatible local API.
