---
title: "ADR-0007: Define six agent roles within a fixed video-memory budget"
type: explanation
summary: "Define six agent roles within a fixed video-memory budget."
audience: maintainer
status: current
verified: 2026-08-15
---

# ADR-0007: Define six agent roles within a fixed video-memory budget
...
One generalist LLM doing planner/coder/vision/critic burns VRAM and conflates skills. Specialist small models on 6 GB RTX 4050 Mobile need routing. The fleet has 16 GB RAM, 6 GB VRAM, 1920x1200@144 Hz target.
