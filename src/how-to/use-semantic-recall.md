...
2. Ask "what did Shesh decide about X last week?" — the agent calls `recall`.
...
code — [documentation policy](../governance/documentation-policy.md) rule 7).
