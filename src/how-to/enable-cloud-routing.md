...
type: how-to
summary: "Gateway API key: generated on first start, stored with 0600 at."
audience: operator
status: current
verified: 2026-08-15
---
...
> podman container and exposes `http://localhost:20128/v1` to every client.
  ...
  ![CI](https://github.com/gaganjainse/shesh-omniroute/actions/workflows/ci.yml/badge.svg)
