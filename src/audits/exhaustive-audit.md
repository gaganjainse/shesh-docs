...
> **2026-08-12 evening addendum.** The historical 54-repo audit below is
> preserved as written. The current live state of the workspace is recorded in
> [`AUDIT_ECOSYSTEM_2026-08-12.json`](AUDIT_ECOSYSTEM_2026-08-12.json)
> (generated by `tools/ecosystem_audit.py`; 28 local clones). Headline delta
...
>   identifiers (ADR-0016/0017); the live names grep clean in source trees.
